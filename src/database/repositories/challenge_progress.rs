use crate::database::dto::challenge_progress::{
    ChallengeId, ChallengeProgressDto, CreateChallengeProgressDto,
};
use crate::database::dto::users::UserId;
use crate::database::extensions::SqlxBindExt;
...
impl ChallengeProgressRepository {
    pub async fn create(
        ...
        create: CreateChallengeProgressDto,
        ...
        .bind(create.user_id)
        .bind(create.challenge_id)
        .bind(create.state)
        .bind_json(create.counters)?
        .bind(create.last_changed)
        .fetch_one(db)
        .await
    }
    ...
    ) -> DbResult<Option<ChallengeProgressDto>> {
        sqlx::query_as(
